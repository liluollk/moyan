package com.liluo.moyan.module.work.controller;
...
public class WorkController {
    ...
    @Operation(summary = "作品排行榜")
    @GetMapping("/ranking")
    public Result<List<WorkVO>> getRankingList(
            @RequestParam(defaultValue = "20") int limit) {
        List<WorkVO> list = workService.getRankingList(limit);
